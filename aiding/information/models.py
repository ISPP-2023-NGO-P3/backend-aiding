...
class Advertisement(models.Model):
    ...
    front_page = models.ImageField(null=False, upload_to='information/advertisements', default="information/media/default.png", validators=[validate_file_extension])

class Multimedia(models.Model):
    advertisement = models.ForeignKey(Advertisement, related_name='advertisement', on_delete = models.CASCADE)
    multimedia = models.ImageField(blank=True, null=True, upload_to='information/multimedia')
