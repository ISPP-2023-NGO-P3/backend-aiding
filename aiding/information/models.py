...
class Advertisement(models.Model):
    title = models.CharField(unique=True, blank=False,
    ...
    front_page = models.ImageField(null=False, upload_to='information/media',
                                   default="information/media/default.png", validators=[validate_file_extension])
...
class Multimedia(models.Model):
    ...
    multimedia = models.ImageField(
        blank=True, null=True, upload_to='information/media')
...
class Resource(models.Model):
    ...
    latitude = models.FloatField(blank=True, max_length=255, validators=[
                                 MaxValueValidator(90), MinValueValidator(-90)])
    longitude = models.FloatField(blank=True, max_length=255, validators=[
