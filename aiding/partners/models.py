...
class Donation(models.Model):
    ...
    def total_donation(self):
        ...
        f_date = self.date.replace(day=31, month=12, year=self.date.year)
        num_days = (f_date-self.date).days()

        num_periods = int(num_days/DonationPeriodicity[self.periodicity].get_periodicity_days())

        return num_periods*self.amount
